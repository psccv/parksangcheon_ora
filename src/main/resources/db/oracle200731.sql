...
Insert into XE.TBL_ATTACH (FULL_NAME,BNO,REGDATE) values ('da999eac-c92c-4d83-85c2-8fc79e5541df.jpg',111,to_date('20/07/30','RR/MM/DD'));
...
Insert into XE.TBL_ATTACH (FULL_NAME,BNO,REGDATE) values ('8f97d731-e753-49dc-a2d5-5908fd48f369.jpg',100,to_date('20/07/30','RR/MM/DD'));
Insert into XE.TBL_ATTACH (FULL_NAME,BNO,REGDATE) values ('5f7bcc71-8949-48ec-8cb0-f2851061fb84.jpg',122,to_date('20/07/31','RR/MM/DD'));
Insert into XE.TBL_ATTACH (FULL_NAME,BNO,REGDATE) values ('a1373a2f-1329-4b8a-9701-542167c681d8.jpg',123,to_date('20/07/31','RR/MM/DD'));
REM INSERTING into XE.TBL_BOARD
SET DEFINE OFF;
Insert into XE.TBL_BOARD (BNO,TITLE,WRITER,REGDATE,UPDATE_DATE,VIEW_COUNT,REPLY_COUNT,BOD_TYPE) values (1,'게시물 제목','관리자',to_timestamp('20/07/30 09:15:37.000000000','RR/MM/DD HH24:MI:SSXFF'),to_date('20/07/30','RR/MM/DD'),0,0,'notice');
...
Insert into XE.TBL_BOARD (BNO,TITLE,WRITER,REGDATE,UPDATE_DATE,VIEW_COUNT,REPLY_COUNT,BOD_TYPE) values (49,'게시물 제목','관리자',to_timestamp('20/07/30 09:15:37.000000000','RR/MM/DD HH24:MI:SSXFF'),to_date('20/07/30','RR/MM/DD'),9,0,'notice');
Insert into XE.TBL_BOARD (BNO,TITLE,WRITER,REGDATE,UPDATE_DATE,VIEW_COUNT,REPLY_COUNT,BOD_TYPE) values (50,'게시물 제목 변경','관리자',to_timestamp('20/07/30 09:15:37.000000000','RR/MM/DD HH24:MI:SSXFF'),to_date('20/07/31','RR/MM/DD'),2,0,'notice');
...
Insert into XE.TBL_BOARD (BNO,TITLE,WRITER,REGDATE,UPDATE_DATE,VIEW_COUNT,REPLY_COUNT,BOD_TYPE) values (99,'게시물 제목','관리자',to_timestamp('20/07/30 09:15:37.000000000','RR/MM/DD HH24:MI:SSXFF'),to_date('20/07/30','RR/MM/DD'),2,0,'gallery');
Insert into XE.TBL_BOARD (BNO,TITLE,WRITER,REGDATE,UPDATE_DATE,VIEW_COUNT,REPLY_COUNT,BOD_TYPE) values (100,'게시물 제목','관리자',to_timestamp('20/07/30 09:15:37.000000000','RR/MM/DD HH24:MI:SSXFF'),to_date('20/07/30','RR/MM/DD'),6,0,'gallery');
Insert into XE.TBL_BOARD (BNO,TITLE,WRITER,REGDATE,UPDATE_DATE,VIEW_COUNT,REPLY_COUNT,BOD_TYPE) values (111,'파일 업로드','둘리',to_timestamp('20/07/30 12:39:07.000000000','RR/MM/DD HH24:MI:SSXFF'),to_date('20/07/30','RR/MM/DD'),9,0,'gallery');
Insert into XE.TBL_BOARD (BNO,TITLE,WRITER,REGDATE,UPDATE_DATE,VIEW_COUNT,REPLY_COUNT,BOD_TYPE) values (123,'공지사항','공지사항',to_timestamp('20/07/31 10:23:23.000000000','RR/MM/DD HH24:MI:SSXFF'),to_date('20/07/31','RR/MM/DD'),8,0,'notice');
Insert into XE.TBL_BOARD (BNO,TITLE,WRITER,REGDATE,UPDATE_DATE,VIEW_COUNT,REPLY_COUNT,BOD_TYPE) values (122,'갤러리','갤러리',to_timestamp('20/07/31 10:23:01.000000000','RR/MM/DD HH24:MI:SSXFF'),to_date('20/07/31','RR/MM/DD'),42,0,'gallery');
REM INSERTING into XE.TBL_MEMBER
SET DEFINE OFF;
Insert into XE.TBL_MEMBER (USER_ID,USER_PW,USER_NAME,EMAIL,POINT,ENABLED,LEVELS,REG_DATE,UPDATE_DATE) values ('admin','$2a$10$hF1.GsIESH2qoy7L5iM1/ONJJg7QUs5JoQCo6bOUhlWnXOw2zb5FK','관리자','test@test.com',0,1,'ROLE_ADMIN',to_date('20/07/29','RR/MM/DD'),to_date('20/07/30','RR/MM/DD'));
Insert into XE.TBL_MEMBER (USER_ID,USER_PW,USER_NAME,EMAIL,POINT,ENABLED,LEVELS,REG_DATE,UPDATE_DATE) values ('dooli','1234','둘리','dooli@test.com',999999999,1,'ROLE_USER',to_date('20/07/29','RR/MM/DD'),to_date('20/07/29','RR/MM/DD'));
Insert into XE.TBL_MEMBER (USER_ID,USER_PW,USER_NAME,EMAIL,POINT,ENABLED,LEVELS,REG_DATE,UPDATE_DATE) values ('user02','$2a$10$4zoZa/5V1GUQ81j.RzBDxuFjVgCJFtPN/g2cPpGD0CZ6Xa.UA3xTq','둘리','test@test.com',112,1,'ROLE_USER',to_date('20/07/29','RR/MM/DD'),to_date('20/07/29','RR/MM/DD'));
